...
<html>
  <head>
	...
	$.get("pageable.spring?indexpages="+indexpages,function(data,status){alert(data+" "+status);});
  ...
  <body>
    ...
    if(pages>1&&currentpages>1&&currentpages!=pages){
     %>
     <a href="pageable.spring?page=<%=currentpages=1%>" align="center">首页</a>
     <a href="pageable.spring?page=<%=currentpages=currentpages-1%>" align="center">上一页</a>
     <a href="pageable.spring?page=<%=currentpages=currentpages+1%>" align="center">下一页</a>
     <%
     }
      %>
      <%
      if(pages>1&&currentpages==pages){
       %>
     <a href="pageable.spring?page=<%=1%>" align="center">首页</a>
     <a href="pageable.spring?page=<%=currentpages=currentpages-1%>" align="center">上一页</a>
     <%
     }
      %>
